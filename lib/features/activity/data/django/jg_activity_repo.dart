...
class DjangoActivityRepo extends IntfActivityRepo {
  ...
  @override
  Future<Activity?> create({required Activity activity, required String userID}) {
  ...
  @override
  Future<Tuple2<String, List<Activity>?>?> fetchListByCategory({required String page, required String activityCategoryID}) {
    // TODO: implement fetchListByCategory
    throw UnimplementedError();
  }
  
  @override
  Future<Tuple2<String, List<Activity>?>?> fetchListByLocation({required String page, required String activityLocationID}) {
  ...
  @override
  Future<Activity?> update({required Activity activity, required String userID}) {
    // TODO: implement update
    throw UnimplementedError();
  }
  
  @override
  Future<bool> userHasJoinedActivity({required String activityID, required String userID}) {
    // TODO: implement userHasJoinedActivity
    throw UnimplementedError();
  }
  
  @override
  Future<bool> userHasLikedActivity({required String activityID, required String userID}) {
